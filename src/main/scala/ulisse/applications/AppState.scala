...
trait AppState:
  ...
  def setupSimulation(update: SimulationManagers => SimulationManager): AppState
...
object AppState:
  ...
  private case class AppStateImpl(
    ...
    override def setupSimulation(update: SimulationManagers => SimulationManager): AppState =
