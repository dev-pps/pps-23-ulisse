...
//object SimulationNotificationListener:
//  def apply(simulationWorkspace: SimulationWorkspace): SimulationNotificationListener =
//    SimulationNotificationListenerImpl(simulationWorkspace)

//  private final case class SimulationNotificationListenerImpl(simulationWorkspace: SimulationWorkspace)
