...
trait OldRouteForm extends FormPanel[BorderPanel]:
...
object OldRouteForm:
  ...
  def apply()(using opaque: Boolean): OldRouteForm = OldRouteFormImpl(createForm)
  ...
  private case class OldRouteFormImpl(form: FormPanel[BorderPanel]) extends OldRouteForm:
    export form.*
